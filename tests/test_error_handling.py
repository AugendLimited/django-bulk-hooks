...
class ValidationErrorsTestCase(TestCase):
    ...
    def test_validation_error_in_bulk_create(self):
        ...
        objects = [
            ErrorTestModel(name='Valid1', required_field='test1', unique_field='unique1'),
            ErrorTestModel(name='INVALID', required_field='test2', unique_field='unique2'),
            ErrorTestModel(name='Valid2', required_field='test3', unique_field='unique3'),
        ]
    ...
    def test_validation_error_in_bulk_update(self):
        ...
        objects = [
            ErrorTestModel.objects.create(name='Test1', value=1, required_field='test1', unique_field='unique1'),
            ErrorTestModel.objects.create(name='Test2', value=2, required_field='test2', unique_field='unique2'),
        ]
        reset_error_state()
...
class HookErrorsTestCase(TransactionTestCase):
    ...
    def test_bulk_operation_partial_failure(self):
        ...
        objects = [
            ErrorTestModel(name='Valid', required_field='test1', unique_field='unique1'),
            ErrorTestModel(name='FAIL_BEFORE', required_field='test2', unique_field='unique2'),
        ]
...
class DatabaseConstraintErrorsTestCase(TransactionTestCase):
    ...
    def test_foreign_key_constraint_error(self):
        ...
        parent = ErrorTestModel.objects.create(
            name='Parent',
            required_field='test',
            unique_field='parent1'
        )

        # Create related object
        child = RelatedErrorModel.objects.create(
            parent=parent,
            description='Child'
        )
...
class EdgeCasesTestCase(TestCase):
    ...
    def test_hook_modifying_other_records(self):
        ...
        ErrorTestModel.objects.create(
            name='Original',
            required_field='orig_req',
            unique_field='orig_unique'
        )
    ...
    def test_recursive_hook_calls(self):
        ...
        ErrorTestModel.objects.create(
            name='Start',
            required_field='start_req',
            unique_field='start_unique'
        )
