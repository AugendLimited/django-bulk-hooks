...
class PriorityOrderingTestCase(TestCase):
    ...
    def test_basic_priority_ordering_before_create(self):
        ...
        before_create_hooks = [
            hook for hook in execution_order 
            if 'before_create' in hook
        ]
    ...
    def test_priority_ordering_before_update(self):
        ...
        # Create object first
        obj = OrderedTestModel.objects.create(name='Test', value=1, created_by=self.user)
        reset_execution_order()
    ...
    def test_priority_with_conditions(self):
        ...
        conditional_hooks_order = [
            hook for hook in execution_order 
            if 'conditional' in hook
        ]

        expected_order = [
            'high_priority_conditional',
            'low_priority_conditional'
        ]
    ...
    def test_hook_registration_order_independence(self):
        ...
        class LateRegisteredHooks(Hook):
            @hook(BEFORE_CREATE, model=OrderedTestModel, priority=Priority.HIGH + 10)  # Higher than existing
    ...
    def test_performance_with_many_hooks(self):
        ...
        for i in range(20):
            ...
            hook_method = hook(BEFORE_CREATE, model=OrderedTestModel, priority=priority)(make_hook(i))
