...
class ConditionTestHooks(Hook):
    ...
    @hook(BEFORE_UPDATE, model=TestAccount, condition=IsGreaterThanOrEqual('balance', 1000))
    ...
    @hook(BEFORE_UPDATE, model=TestAccount, condition=HasChanged('balance') & IsEqual('status', 'active'))
    ...
    @hook(BEFORE_UPDATE, model=TestAccount, condition=IsEqual('status', 'premium') | IsEqual('status', 'vip'))
...
class ConditionsTestCase(TestCase):
    ...
    def test_has_changed_condition(self):
        ...
        account = TestAccount.objects.create(name='Test', balance=100, created_by=self.user)
        reset_condition_state()
    ...
    def test_is_equal_condition(self):
        ...
        account = TestAccount.objects.create(name='Test', status='active', created_by=self.user)
        reset_condition_state()
    ...
    def test_was_equal_condition(self):
        ...
        account = TestAccount.objects.create(name='Test', status='pending', created_by=self.user)
        reset_condition_state()
    ...
    def test_greater_than_condition(self):
        ...
        account = TestAccount.objects.create(name='Test', balance=500, created_by=self.user)
        reset_condition_state()
    ...
    def test_less_than_condition(self):
        ...
        account = TestAccount.objects.create(name='Test', priority=3, created_by=self.user)
        reset_condition_state()
    ...
    def test_less_than_or_equal_condition(self):
        ...
        account = TestAccount.objects.create(name='Test', priority=5, created_by=self.user)
        reset_condition_state()
    ...
    def test_and_condition(self):
        ...
        account = TestAccount.objects.create(name='Test', balance=100, status='active', created_by=self.user)
        reset_condition_state()

        # Change balance while active - should trigger both conditions
        account.balance = 200
        account.save()
        self.assertIn('balance_changed_and_active', condition_state['triggered_conditions'])
        ...
        account.balance = 300
        account.save()
        self.assertNotIn('balance_changed_and_active', condition_state['triggered_conditions'])
    ...
    def test_or_condition(self):
        ...
        account.status = 'inactive'
        account.save()
        self.assertNotIn('status_premium_or_vip', condition_state['triggered_conditions'])
    ...
    def test_resolve_dotted_attr(self):
        ...
        self.assertEqual(resolve_dotted_attr(account, 'created_by.username'), 'testuser')
    ...
    def test_complex_condition_combinations(self):
        ...
        class ComplexConditionHooks(Hook):
            @hook(BEFORE_UPDATE, model=TestAccount, 
        ...
        account = TestAccount.objects.create(name='Test', balance=50, status='active', created_by=self.user)
        reset_condition_state()
    ...
    def test_condition_edge_cases(self):
        ...
        account = TestAccount.objects.create(name='Test', balance=0, created_by=self.user)
